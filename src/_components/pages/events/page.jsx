...
const events = [
    {
        ...
        venue: "LHC 005",
        description:
            "The wait for all the Machine Learning and Quantum Computing enthusiasts is finally over!",
        image: Image1,
    },
    {
        ...
        venue: "SMP Office",
        description:
            "SMP conducts cross-mentorship intra-batch and inter-branch as well.",
        image: Image2,
    },
    {
        ...
        venue: "LHC 005",
        description:
            "Here comes the most awaited session of the series, all you need to know about Software Engineering.",
        image: Image3,
    },
    {
        ...
        venue: "LHC 005",
        description:
            "Get a real outlook of the corporate world and make better decision about your chosen field.",
        image: Image4,
    },
];
