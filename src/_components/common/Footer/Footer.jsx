      ...
      <div className={styles.footer_main}>
        <div className={styles.footer_main_left}>
          ...
          <div className={styles.footer_main_left_text}>
            <span>
              It is one of the largest on-campus student body initiatives which
              assigns a mentor (a Pre-Final or Final year student) to all the
              freshmen within the same branch.
            </span>
          </div>
        ...
        <div className={styles.footer_main_right}>
          <div className={styles.footer_main_right_icons}>
            {socialMediaLinks.map((object, index) => {
              return (
                <Link key={index} href={object.link} target="_blank">
