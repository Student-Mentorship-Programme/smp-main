...
const Footer = () => {
    ...
    const socialMediaLinks = [
        ...
        {
            icon: facebookIcon,
            link: "https://www.facebook.com/MentorshipIITR/",
        },
        {
            icon: linkedinIcon,
            link: "https://www.linkedin.com/company/smpiitr/mycompany/",
        },
    ];
            ...
            <div className={styles.footer_main}>
                <div className={styles.footer_main_left}>
                    ...
                    <div className={styles.footer_main_left_text}>
                        <span>
                            The Student Mentorship Program is an initiative
                            under the aegis of the Dean of Students' Welfare
                            that aims to create a structured student body to
                            foster healthy interaction between the juniors and
                            the seniors of the institute
                        </span>
                    </div>
                    ...
                    <div className={styles.footer_middle_container}>
                        ...
                        <div className={styles.footer_middle_content}>
                            ...
                            <span>
                                ...
                                Roorkee, Haridwar District, Uttarakhand, India{" "}
                                <br />
                                Pin: 24667
                            </span>
                        </div>
